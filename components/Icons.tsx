...
export const CogIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M19.14 12.94c.04-.3.06-.61.06-.94s-.02-.64-.07-.94l2.03-1.58a.5.5 0 0 0 .12-.63l-1.43-2.47a.5.5 0 0 0-.61-.22l-2.49 1a6.32 6.32 0 0 0-1.83-1.28l-.39-2.65A.5.5 0 0 0 14.25 2h-2.5a.5.5 0 0 0-.49.42l-.39 2.65a6.34 6.34 0 0 0-1.83 1.28l-2.49-1a.5.5 0 0 0-.61.22l-1.43 2.47a.5.5 0 0 0 .12.63l2.03 1.58c-.05.3-.07.64-.07.94s.02.64.07.94l-2.03 1.58a.5.5 0 0 0-.12.63l1.43 2.47a.5.5 0 0 0 .61.22l2.49-1a6.32 6.32 0 0 0 1.83 1.28l.39 2.65a.5.5 0 0 0 .49.42h2.5a.5.5 0 0 0 .49-.42l.39-2.65a6.34 6.34 0 0 0 1.83-1.28l2.49 1a.5.5 0 0 0 .61-.22l1.43-2.47a.5.5 0 0 0-.12-.63l-2.03-1.58z"></path>
